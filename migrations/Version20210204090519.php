 ...
 */
final class Version20210204090519 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE project ADD CONSTRAINT FK_2FB3D0EEB6EC9B9 FOREIGN KEY (type_project_id) REFERENCES type_project (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE project ADD CONSTRAINT FK_2FB3D0EE8FD4693C FOREIGN KEY (type_of_project_id) REFERENCES type_project (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
